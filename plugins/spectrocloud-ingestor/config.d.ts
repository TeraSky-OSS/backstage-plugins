/**
 * Configuration schema for the SpectroCloud catalog ingestor module.
 * 
 * This module extends the catalog plugin to ingest SpectroCloud resources
 * into the Backstage catalog.
 * 
 * The ingestor discovers and creates:
